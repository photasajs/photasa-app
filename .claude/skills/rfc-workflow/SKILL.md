...
description: >-
  ...
  in docs/rfc/README.md. Use when the user mentions RFC, ROADMAP, roadmap, TASK_TRACKING,
...
| `docs/rfc/README.md` | RFC **目录约定**（命名、元数据、正文结构、`assets/`）；**不是**进度表。 |
...
2. 新建 `docs/rfc/NNN-kebab-case-title.md`（命名见 **`docs/rfc/README.md`**）。
