...
- **RFC编号**: 0007
- **标题**: Folder Scan Cache Optimization
- **作者**: 李鹏
- **状态**: ✅ **已实现并验证**
- **日期**: 2025-09-06
- **替代**: 无
- **相关**: RFC 0003 (Unify Watch to Scan Queue)
...
// 使用增量缓存包装扫描函数
const result = await withIncrementalCache("/path/to/folder", logger, async (cacheManager) => {
    // 扫描过程中的文件处理
