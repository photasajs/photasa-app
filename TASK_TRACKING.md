...
| [0132](./.spec/rfc/0132-tauri-photasa-scan-crate.md)                         | `photasa-scan` 独立 crate                                | ⏳ Draft       | 策略/缓存/walk/notify 零 Tauri；依赖 photasa-import                      |
| [0133](./.spec/rfc/0133-tauri-photasa-watch-crate.md)                        | `photasa-watch` 独立 crate                               | ⏳ Draft       | coalescer 零 Tauri；不依赖 photasa-scan                                  |

**Gap/T3 铁律：** 一事一 RFC；禁 mono 袋。Import 线已清：**0118–0131**（0120/0121 ✅，0122/0126 ❌）；**P0-infra next：0132 scan / 0133 watch** ⏳；Import Deferred 已清零。
...
| [0070](./.spec/rfc/0070-tauri-import-service-migration.md)                 | 导入服务迁移到 Tauri                                 | Implemented（细项对拍见 0097）   | AI     | v2.1.0         |
