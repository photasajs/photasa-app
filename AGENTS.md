...
- **Cursor agent skills**: Reusable workflows live under `.cursor/skills/<skill-name>/SKILL.md` (e.g. `.cursor/skills/tauri-debug-investigate/` for Tauri debugging with MCP; `.cursor/skills/rfc-management/` + `.cursor/skills/rfc-workflow/` for generic RFC lifecycle with `ROADMAP.md` + `.spec/rfc/`).
