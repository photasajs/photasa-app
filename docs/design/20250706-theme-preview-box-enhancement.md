...
const previewColors = computed(() => ({
    ...
    secondary: props.colors['bg-secondary'] || props.colors['bg_secondary'] || props.colors.background || '#f3f3f3',
    primary: props.colors.primary || '#0066b8',
    cardBg: props.colors['card-bg'] || props.colors['card_bg'] || props.colors['bg-secondary'] || '#f3f3f3',
}));
```
