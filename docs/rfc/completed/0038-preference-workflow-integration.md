...
class ChuSuiLiangService {
    private qizouLishiming(matter: string, content: Record<string, unknown>, type: 'request' | 'report'): void {
        const qizou: Qizou = {
            matter: matter,
            content: content,
            from: '褚遂良',
...
class DuRuHuiService {
    ...
    private onResponseCallback: ((serviceName: string, response: ShengzhiResponse) => void) | null = null;
