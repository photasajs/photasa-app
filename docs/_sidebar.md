...
* **RFC 文档**
  ...
  * **已完成**
    ...
    * [RFC 0036: 文昌偏好集成](rfc/completed/0036-wenchang-preference-integration.md)
    * [RFC 0035: 五引擎编排架构](rfc/completed/0035-five-engine-orchestration-architecture.md)
    * [RFC 0041: 偏好架构重构](rfc/completed/0041-preference-architecture-refactor-business-logic-separation.md)
    * [RFC 0040: removePath功能修复](rfc/completed/0040-removepath-functionality-fix.md)
