...
graph TD
  apply_system_menu["太白金星：设置系统菜单"]
  format_response["返回成功结果"]
  apply_system_menu --> format_response
  ...
  class apply_system_menu action
...
sequenceDiagram
  ...
  Orchestrator->>+taibaijinxing: applySystemMenu
