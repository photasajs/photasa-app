...
export const SystemMenus: readonly MenuItemData[] = Object.freeze([
    // macOS 专属 appMenu
    {
        ...
        items: [
            ...
            { key: "app.separator-1", label: "menu.separator", role: "separator" },
            { key: "app.services", label: "menu.app.services", role: "services" },
            { key: "app.separator-2", label: "menu.separator", role: "separator" },
            ...
            { key: "app.separator-3", label: "menu.separator", role: "separator" },
    ...
    // View 菜单
    {
        ...
        items: [
            ...
            { key: "view-separator-1", label: "menu.separator", role: "separator" },
            ...
            { key: "view-separator-2", label: "menu.separator", role: "separator" },
            {
