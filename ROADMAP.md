...
| [0165](.spec/rfc/completed/0165-base-tree-package-and-folder-restore.md)           | `@photasa/base-tree` 包 + 启动树选中恢复 + 虚拟化无回归                                  | ✅ Implemented — `@photasa/base-tree` 包；启动展开+选中；大目录虚拟化手测通过（2026-07-24）                                                          |
