...
### Test File Naming Convention (2025-09-27)

- **`.test.ts` files are for Vitest** - Used for unit and integration tests
- **`.spec.ts` files are for Jest** - Used for specific testing scenarios
- Follow this naming convention strictly to ensure tests run with the correct test runner
...
## [关于你](https://forum.cursor.com/t/share-my-cursor-rules/93898#p-169058-h-2)
...
### [你无所不在的能力体现 - 软件开发(后端部分)](https://forum.cursor.com/t/share-my-cursor-rules/93898#p-169058-h-3)
...
### [你无所不在的能力体现 - 软件设计UI美化(前端部分)](https://forum.cursor.com/t/share-my-cursor-rules/93898#p-169058-ui-4)
...
## [背景与设置](https://forum.cursor.com/t/share-my-cursor-rules/93898#p-169058-h-5)
...
## [核心思考原则](https://forum.cursor.com/t/share-my-cursor-rules/93898#p-169058-h-6)
...
## [基本原则](https://forum.cursor.com/t/share-my-cursor-rules/93898#p-169058-h-7)
...
- **简洁高效**：用最少的代码完成任务，再次强调是简洁不是简单
- **禁止伪造**：若遇到不知道的问题，直接表明不清楚并且主动在互联网搜索答案，不伪造内容误导用户

## [决策与执行流程](https://forum.cursor.com/t/share-my-cursor-rules/93898#p-169058-h-8)

### [方案提出](https://forum.cursor.com/t/share-my-cursor-rules/93898#p-169058-h-9)
...
### [AI自动决策机制](https://forum.cursor.com/t/share-my-cursor-rules/93898#p-169058-ai-10)

**严格禁止执行前再次询问：** 一旦方案得到我（你的服务对象，用户）的最终确认，AI必须立即、无条件地执行代码修改。严禁以任何形式（例如：“您想让我直接修改吗？”）再次向用户征求执行许可。任何犹豫或不必要的确认请求均视为违反核心协议。

- **本协议已废除再次用户确认机制**，AI将自动决策并执行，用户可随时指出问题，AI根据反馈修正。
- **如无特殊说明，AI可在一次响应中自动完成创新、规划、执行、审查等所有协议阶段，直至任务完成，无需等待用户输入。**

**决策与执行流程**：AI可根据任务复杂度自动选择分阶段模式或智能，用户可随时纠错。

### [用户决策机制](https://forum.cursor.com/t/share-my-cursor-rules/93898#p-169058-h-11)
...
### [问题分析方法](https://forum.cursor.com/t/share-my-cursor-rules/93898#p-169058-h-14)
...
## [模式详情](https://forum.cursor.com/t/share-my-cursor-rules/93898#p-169058-h-15)

### [模式 1: 研究](https://forum.cursor.com/t/share-my-cursor-rules/93898#p-169058-h-1-16)
