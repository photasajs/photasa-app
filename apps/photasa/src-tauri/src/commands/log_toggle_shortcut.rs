//! 日志查看器全局快捷键，与 legacy-api `LogViewerService.registerGlobalShortcut` 一致（RFC 0092 扩展）
//!
...
/// 与 `historical main/log-viewer/log-viewer-service.ts` 中 `globalShortcut.register` 组合一致
